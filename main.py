...
**Click Below Button To Join.👇🏻**''', buttons=Button.url('🍿Updates Channel🍿', f'https://t.me/{Config.UPDATES_CHANNEL_USERNAME}'))
...
**Click On The Help To Know How To Watch**
    '''
            ...
            newbutton = [Button.url('Help🙋',
                                    f'https://t.me/Abhithemachineguner')]
        ...
        print(e)
        await txt.delete()
        result = await event.reply("I am Unable Search,Please Search In @popcornpanda🙏")
        await asyncio.sleep(Config.AUTO_DELETE_TIME)
        await event.delete() 
        return await result.delete()
